...
import { increment,decrement,decrementMultiplier,incrementMultiplier } from '../../redux/store'
            ...
            <div className='border p-4'>
              ...
              <div className='row'>
                 <div className='col-4 p-1'>
                    <input type='text' placeholder='multiplier...' value={multiplier} onChange={(e)=>setMultiplier(e.target.value)} className='form-control'/>
                 </div>
                 <div className='col-4 p-1'>
